...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Portofolio</h4>
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-end">
                <a href="{{ route('admin.portfolio.create') }}" class="btn btn-primary btn-rounded"><i class="fas fa-plus"></i>     Tambah Portofolio</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <table id="multi_col_order" class="table border table-striped table-bordered text-nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $port -> title }}</td>
                                <td>{{ $port->category == 'Adv' ? 'Agusta Advertising' : ($port->category == 'Car' ? 'Agusta Motor' : 'Agusta Properti') }}</td>
                                <td>
                                    <a href="{{ route('admin.portfolio.show', $port) }}" type="button" class="btn btn-success btn-rounded"><i class="far fa-folder-open"></i> Detail</a>
