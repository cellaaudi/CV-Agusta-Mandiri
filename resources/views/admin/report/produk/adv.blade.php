            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a>Agusta Advertising</a>
                        </li>
                    </ol>
                </nav>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Agusta Advertising</h4>
                <h6 class="card-subtitle">Berdasarkan produk Agusta Advertising yang paling banyak dipesan saat membuat janji temu.</h6>
...
<script>
    ...
    function getData(awal, akhir) {
        $.ajax({
            type: 'POST',
            url: '{{ route("admin.report.product.adv") }}',
            data: {
                "_token": "{{ csrf_token() }}",
                "awal": awal,
                "akhir": akhir
            ...
            success: function(data) {
                ...
                if (data.products.length > 0) {
                    $.each(data.products, function(index, product) {
                        var categoryText = ((product.category == 'IO') ? 'Indoor & Outdoor' : product.category);
                    ...
                    tableBody.html('<tr><td colspan="5" class="text-center">Tidak ada data tercatat pada tanggal tersebut</td></tr>');
                }
            }
        });
    }
