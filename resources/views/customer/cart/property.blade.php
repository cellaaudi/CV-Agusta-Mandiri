                    ...
                    <div class="card mb-3 cardt" style="max-width: 800px;">
                        <div class="row g-0">
                            <div class="col-md-4 preview">
                                ...
                                <img id="photoPreview" src="{{ asset('storage/' . $photo->url) }}" class="img-fluid mx-auto d-block rounded-start" alt="{{ $cart->title }}">
                                @break
                                @endif
                                @endforeach
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small class="text-muted">Kategori :</small> {{$cart->category }}</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('customer.appointment.property.index') }}" class="add-cart btn" type="button">Pilih Jadwal</a>
                            </div>
                        </div>
                    </div>
                </div>
