                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <div class="d-grid gap-2 mb-3">
                            <button id="btnAddCart" class="add-cart" data-prop="{{ $prop }}"
                        ...
                        <div class="portfolio-info">
                            ...
                            <div class="row mb-2">
                                ...
                                <span
                                    class="col-sm-7 ">{{ $prop->category == 'House' ? 'Rumah' : ($prop->category == 'Land' ? 'Tanah' : 'Villa') }}</span>
                            </div>
                            <div class="row mb-2">
                                <span class="col-sm-5 text-muted"><small>Tipe</small></span>
                                <span
                                    class="col-sm-7">{{ $prop->type == 'Sell' ? 'Jual' : ($prop->type == 'Rent' ? 'Sewa' : 'Jual dan Sewa') }}</span>
                            </div>
                            <div class="row mb-2">
...
@section('jquery')
    <script>
        function addToCart(button) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('customer.cart.property.store') }}",
                data: {
